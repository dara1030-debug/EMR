      ...
      <div class="card-body">
        ...
        <div class="row">
            <form action="{{ route('patients.update', $patient->id) }}" method="post">
                @csrf
                @method('PUT')
                <img src="/img/Picture1.png" alt="create_avatar" class="create_avatar"><br> {{--Update Profile Uploaded (Restrict user thaht only img/png file can be uploaded )--}}
                        ...
                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <a href="/patients" class="btn btn-secondary btn-md">Cancel</a>
                                    </div>
                                </div>
                    </div>
                </div>
