...
<div class="custom-control custom-radio ">
@if(isset($patient->getSocialHistory()['is_smoking']))
<input type="radio" class="custom-control-input" id="choice1" name="is_smoking" {{ $patient->getSocialHistory()['is_smoking'] == 'Yes' ? 'checked' : '' }} value="Yes">
@else
<input type="radio" class="custom-control-input" id="choice1" name="is_smoking" value="Yes">
@endif
...
<input type="radio" class="custom-control-input" id="choice1" name="is_drinking_beer" {{ $patient->getSocialHistory()['is_drinking_beer'] == 'No' ? 'checked' : '' }} value="No">
@else
<input type="radio" class="custom-control-input" id="choice1" name="is_drinking_beer" value="No">
@endif
...
<div class="custom-control custom-radio ">
@if(isset($patient->getSocialHistory()['is_drinking_beer']))
<input type="radio" class="custom-control-input" id="choice1" name="is_drinking_beer" {{ $patient->getSocialHistory()['is_drinking_beer'] == 'Yes' ? 'checked' : '' }} value="Yes">
@else
<input type="radio" class="custom-control-input" id="choice1" name="is_drinking_beer" value="Yes">
@endif
