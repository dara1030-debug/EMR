      ...
      <div class="container register"  style="margin-left: 12%">
        <div class="row">           
                ...
                <div class="tab-content" id="myTabContent" >
                    ...
                    <? WILL SHOW MARKED ITEMS ONLY ?>
                    <div class="container register"> <br>             
                        <h3 class="register-heading text-left"><br><mark style="background-color:#d7e7f3">A. PAST MEDICAL HISTORY</h3><br></mark>
                        <div class="row">
                    ...
                    <br><h3 class="register-heading text-left"><br><mark style="background-color:#D7e7f3">B. FAMILY HISTORY</h3><br></mark>
                        <div class="row">
                                <div class="col text-left">
                    ...
                    <h3 class="register-heading text-left"><br><mark style="background-color:#d7e7f3">C. SOCIAL HISTORY</h3><br></mark>
                         <div class="row">
                            <div class="col text-left">
                                <form action="">
                                <h6>  1. Do you Smoke? 
                         ...
                         <br><br><h3 class="register-heading text-left"><mark style="background-color:#d7e7f3">D. PHYSICAL EXAMINATION </h3></mark>
                         <div class="row">
                            <div class="col text-left">
                              <p><i> (To be accomplished  by Physician )</i></p>
                         ...
                         <br><br><br><br><h3 class="register-heading text-left"><mark style="background-color:#d7e7f3">E. VITAL SIGNS</h3></mark>
                         <div class="row">
                            <div class="col text-left">
                                    <form action="">
                                    <tr> <br>
                        ...
                        <br><br><h3 class="register-heading text-left"><mark style="background-color:#d7e7f3">F. NURSING INTERVENTIONS</h3><br></mark>
                         <div class="row">
                            <div class="col text-left">
                                <form action="">
                                <table>
                        ...
                        <br><h3 class="register-heading text-left"><mark style="background-color:#d7e7f3">G. ASSESSMENT AND RECOMMENDATIONS</h3></mark>
                         <div class="row">
                            <div class="col text-left">
                                <form action="">
                                <h6> <h6>
